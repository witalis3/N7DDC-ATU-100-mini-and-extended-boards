#line 1 "D:/mikroC PRO for PIC/Examples/ATU_100_memo/N7DDC-ATU-100-mini-and-extended-boards/ATU_100_EXT_board/FirmWare_PIC18F2520/2520_EXT_board_sources_V_3.1/main.c"
...
#line 1 "d:/mikroc pro for pic/examples/atu_100_memo/n7ddc-atu-100-mini-and-extended-boards/atu_100_ext_board/firmware_pic18f2520/2520_ext_board_sources_v_3.1/pic_init.h"
...
void pic_init (void);
#line 1 "d:/mikroc pro for pic/examples/atu_100_memo/n7ddc-atu-100-mini-and-extended-boards/atu_100_ext_board/firmware_pic18f2520/2520_ext_board_sources_v_3.1/main.h"
...
#line 54 "D:/mikroC PRO for PIC/Examples/ATU_100_memo/N7DDC-ATU-100-mini-and-extended-boards/ATU_100_EXT_board/FirmWare_PIC18F2520/2520_EXT_board_sources_V_3.1/main.c"
 ...
 led_wr_str(0, 0, "Fider Loss input", 16);
 led_wr_str(1, 3, "dB", 2);
 }
...
void button_delay() {
 if ((Button( & PORTB, 0, 25, 0)) | (Button( & PORTB, 1, 25, 0)) |
 (Button( & PORTB, 2, 25, 0))) {
 but = 1;
 }
 return;
...
void show_pwr(int Power, int SWR) {
 ...
 if (type == 4 | type == 5)
 led_wr_str(4, 16 + 4 * 12, work_str_2, 4);
 else if (type == 2 | type == 3)
 led_wr_str(0, 13, work_str_2, 4);
 else if (type == 1)
 led_wr_str(0, 12, work_str_2, 4);
...
void lcd_pwr() {
 ...
 (SWR_fixed < SWR_fixed_old & (SWR_fixed_old - SWR_fixed) > delta) |
 SWR_fixed_old == 999))
 Soft_tune = 1;
